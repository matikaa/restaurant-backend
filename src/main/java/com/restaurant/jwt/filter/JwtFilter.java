package com.restaurant.jwt.filter;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            response.getWriter().write(ConstantValues.NO_ACCESS);
        }
    }

    private String getToken(HttpServletRequest request) {
        String header = request.getHeader(ConstantValues.AUTHORIZATION);
        if (header != null && header.startsWith(ConstantValues.TOKEN_PREFIX)) {
